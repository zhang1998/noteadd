...
{//创建主窗口
    ...
    GtkWidget *menutoggle;
    GtkWidget *menu_tog_toggle,*menu_tog_toolbar, *menu_tog_statusbar;  //界面开关菜单
    ...
    gtk_window_set_title(GTK_WINDOW(window), "noteadd");
    ...
    gtk_window_set_icon(GTK_WINDOW(window), create_pixbuf("./images/bear.jpg"));
    ...
    menu_tog_toggle = gtk_menu_item_new_with_label("文件");
